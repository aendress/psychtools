...
\affiliation{Department of Psychology, City St George's, University of London}
\leftheader{Endress}

\authornote{%
  This document was generated automatically as a usage demonstration for
  the \textit{psychtools} \LaTeX{} package. All data are simulated for
  illustrative purposes.\\
  Contact: \protectedemail{ansgar.endress@m4x.org}%
}
