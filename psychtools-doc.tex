...
Typesets \meta{text} in red.  With the \opt{nocolorize} package
option, \meta{text} is typeset in the normal text colour instead.
This command is used internally by the draft-heading and
\cmd{footnotewithdetails} commands, but it is also available for
direct use if you want to highlight other draft material.
